    ...
    return modules = [ function(module) {
        ...
        function isDateInRange(dateParts, result, opts, maskset) {
            ...
            if (opts.min) {
                ...
                // dateParts.year is input date
                // opt.max.date is max date with iso format
                // opt.max.rawyear is max year with string format
                // console.log(`dateparts rawyear is : ${dateParts.rawyear} and datepart year ${dateParts.year}`);
