            ...
            <div class="text-center" style="border: 1px solid #E3E3E3; background-color:#FBFBFB">
                ...
                action="patient-register-form">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="" id="rhc_label" class="col-md-4 control-label" style="word-wrap: anywhere;"></label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label for="" id="sc_label" class="col-md-4 control-label" style="word-wrap: anywhere;"></label>
                            <div class="col-md-8">
