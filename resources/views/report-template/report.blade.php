		...
		$( document ).ready(function() {		
			...
			for (var i = 1; i<2;  i++) {
			   ...
			   for (var j = 0, col; col = row.cells[j]; j++) {
				...
				if(parseInt(col.innerHTML) || col.innerHTML == "0" && col.headers != "PYear" && col.headers.toLowerCase() != "pyear" && col.headers.toLowerCase() != "year" && col.headers.toLowerCase() != "monthcode"){
					var totalVal = 0;
					...
					if($("#tf_"+j).html() == "PYear" || $("#tf_"+j).html() == "PMonth" || $("#tf_"+j).html() == "Agegroup" || $("#tf_"+j).html() == "AgeGroup"
					|| $("#tf_"+j).html() == "No"){
						$("#tf_"+j).html("");
					} else {
						$("#tf_"+j).html(totalVal);
