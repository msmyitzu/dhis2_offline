                                ...
                                <div class="form-group col-md-5" id="data_entry_type">
                                    ...
                                    <div class="">
                                        <select id="dataEntry" name="dataEntry" class="form-control select2"
                                            style=" height:50px;">
                                            <option value="option1" disabled>ရွေးပါ</option>
                ...
                <tbody align="left">
                    ...
                    <tr>
                        <td style="padding:10px 50px 10px 30px; margin-right:20px">
                            ...
                            <input type="text" id="txt_total_inpatient"
                        ...
                        <td style="padding:10px 50px 10px 30px; margin-right:20px">
                            ...
                            <small style="font-weight: 700; font-size: 15px;"> ငါးနှစ်အောက်အထွေထွေဆေးခန်းလာ(အတွင်း)
                                - </small>
                            <input type="text" id="txt_total_in_child" value="{{ $tbl_nil->u5_inpatient }}"
                                style="width: 20%; ">
                        ...
                        <td style="padding:10px 50px 10px 30px; margin-right:20px">
                            ...
                            <small style="font-weight: 700; font-size: 15px;">
                                ...
                                - </small>
                            <input type="text" id="txt_total_preg_in" value="{{ $tbl_nil->preg_inpatient }}"
                    ...
                    <tr>
                        ...
                        <td style="padding:10px 50px 10px 30px; margin-right:20px">
                            ...
                            <input type="text" id="txt_total_death_in" value="{{ $tbl_nil->death_facility }}"
                                style="width: 20%; ">
                    ...
                    @if (isset($tbl_individual_cases))
                        @foreach ($tbl_individual_cases as $cases)
                            <tr id="data_entry_row">
                                <td style="font-size:10px; font-weight: bold;" P_Number="0">{{ $cases->ic_id }}
                                </td>
                                <td>
                                ...
                                <td><input type="text" id="" oninput="adjustInputWidth(this)"
                                        placeholder="အဘအမည်" value="{{ $cases->pt_father_name }}" required></td>
                                ...
                                <td>
                                    <select class="" name="address" id=""
                                        ...
                                        <option value="" disabled>ရွေးပါ</option>
                                        {{-- <option value="{{ $cases->pt_address }}">{{ $cases->pt_address }}</option> --}}
                                        <option value="No (within Township)"
                                            {{ $cases->pt_address == 'No (within Township)' ? 'selected' : '' }}>
                                            No (Within township)</option>
                                ...
                                <td>
                                    <select name="preg" id="preg" class="preg"
                                        ...
                                        <option value="Yes" {{ $cases->Preg_YN == 'Yes' ? 'selected' : '' }}>
                                            Yes</option>
                                        <option value="No" {{ $cases->Preg_YN == 'No' ? 'selected' : '' }}>
                                            No</option>
                                ...
                                <td>
                                    <select name="rsc_test" id="rsc_test"
                                        ...
                                        <option value="neg"
                                            {{ $cases->Micro_Code == 'neg' ? 'selected' : '' }}>Negative</option>
                                        <option value="pf"
                                            {{ $cases->Micro_Code == 'pf' ? 'selected' : '' }}>Pf</option>
                                        <option value="pv"
                                            {{ $cases->Micro_Code == 'pv' ? 'selected' : '' }}>Pv</option>
                                        <option value="mixed"
                                            {{ $cases->Micro_Code == 'mixed' ? 'selected' : '' }}>Mixed</option>
                                        <option value="pm"
                                ...
                                <td>
                                    <select name="rdt_test" id="rdt_test" class=""
                                        ...
                                        <option value="pf" {{ $cases->RDT_Code == 'pf' ? 'selected' : '' }}>
                                            Pf</option>
                                        <option value="pv" {{ $cases->RDT_Code == 'pv' ? 'selected' : '' }}>
                                            Pv</option>
                                        <option value="mixed"
                                ...
                                <td>
                                    <select name="out-patient" id="" oninput="adjustInputWidth(this)"
                                        style="width: 100%">
                                        ...
                                        <option value="Severe (OP)"
                                            {{ $cases->IOC_Code == 'Severe (OP)' ? 'selected' : '' }}>Severe (OP)
                                        </option>
                                ...
                                <td>
                                    <select name="CQ" id="cq" class="cq">
                                        <option value="N/A" {{ $cases->CQ_Code == 'N/A' ? 'selected' : '' }}>
                                            N/A</option>
                                        ...
                                        <option value="CQ - 10 tablets"
                                            {{ $cases->CQ_Code == 'CQ - 10 tablets' ? 'selected' : '' }}>CQ - 10
                                            tablets</option>
                                        <option value="Out of stock"
                                ...
                                <td><select name="PQ" id="pq" class="pq">
                                        ...
                                        <option value="N/A" {{ $cases->PQ_Code == 'N/A' ? 'selected' : '' }}>
                                            N/A</option>
                                        ...
                                        <option value="PQ - 14 tablets"
                                            {{ $cases->PQ_Code == 'PQ - 14 tablets' ? 'selected' : '' }}>PQ - 14
                                            tablets</option>
                                        <option value="PQ - 21 tablets"
                                            {{ $cases->PQ_Code == 'PQ - 21 tablets' ? 'selected' : '' }}>PQ - 21
                                            tablets</option>
                                        <option value="PQ - 28 tablets"
                                            {{ $cases->PQ_Code == 'PQ - 28 tablets' ? 'selected' : '' }}>PQ - 28
                                            tablets</option>
                                        <option value="Out of stock"
                                ...
                                <td>
                                    <select name="job" id="job" oninput="adjustInputWidth(this)"
                                        ...
                                        <option value="Gardening"
                                            {{ $cases->occupation == 'Gardening' ? 'selected' : '' }}>Gardening
                                        </option>
                                        ...
                                        <option value="Other"
                                            {{ $cases->occupation == 'Other' ? 'selected' : '' }}>Other</option>
