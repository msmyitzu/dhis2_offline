                                ...
                                <tbody id="grab_all_corefacility_container">
                                    ...
                                    @foreach($grab_all_corefacility as $cf)
                                        <tr title="လူနာအချက်အလက်များကြည့်ရန် နှိပ်ပါ" id="tr_{{ $cf->cf_link_code }}" 
                                            ...
                                            <th align="right" cf_code="{{ $cf->CF_Code }}">{{ $counter-- }}</th>
                                            ...
                                            <td align="center" width="100px" id="td_0{{ $cf->cf_link_code }}">
                                                ...
                                                <button class="btn btn-danger btn-xs" onclick="del_req({{ $cf->cf_link_code }},{{ $cf->CF_Code }},0);">
            ...
            <div class="modal fade" id="modal-default">
                <div class="modal-dialog">
                    ...
                    <div class="callout callout-warning">
                        ...
                        <p>
                        ဖျက်လိုသည့်အချက်အလက်အား သေချာစွာစစ်ဆေးပြီး မှန်ကန်မှ ပို့ပါ။ ဌာနချုပ်တွင် ဖျက်ပြီးပါက ပြန်လည်ရယူနိုင်ခြင်းမရှိပါ။
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">ပိတ်မည်</button>
                        <button type="button" class="btn btn-primary" id="btn_send" onClick="send_delete_request()">
                            <li class="fa fa-send" /><span style="font-family : mmFont !important">ပို့မည်</span>
                        </button>
                    </div>
                    </div>
                    <!-- /.modal-content -->
        ...
        <script>
            ...
            function send_delete_request()
            {
                ...
                if(remark.trim() == ""){
                    ...
                    xmlhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            if(xmlhttp.responseText == "1"){
                                $("#td_"+item_type+cf_link_code).html('...<li class="fa fa-question-circle" title="ဖျက်ခွင့်တောင်းထားသည်" />');
                    ...
                    xmlhttp.send("cf_link_code="+cf_link_code+"&item_id="+item_id+"&item_type="+item_type+"&remark="+remark);
                }
                            ...
                            if(data.length > 0){
                                jQuery.each(data, function(i, val) {
                                    ...
                                    if(val.delete_requested == 0){
                                        tr += `<td align="center" width="100px" id="td_1${val.cf_link_code}"><button class="btn btn-danger btn-xs" onclick="del_req(${cf_link_code},${val.P_Number},1);"><li class="fa fa-trash"></li> ဖျက်ရန်</button></td>`;
                                        ...
                                        tr += '<td align="center" width="100px">...<li class="fa fa-question-circle" title="ဖျက်ခွင့်တောင်းထားသည်" /></td>';
                                    }
                                    tr += "</tr>";
