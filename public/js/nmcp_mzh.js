...
function load_reportpage(select_reportpage, token) {
    try {
        if (select_reportpage == "reportby_sc") {
            ...
            bootbox.alert("စာရင်းချုပ်အမျိုးအစားရွေးချယ်ပါ")
        }
    } catch (error) {
        bootbox.alert(error.message);
    }
...
function checkAge(age) {
    ...
    if ((char >= 0) && (char <= 110)) {
        if (char <= 10 || char >= 60) {
            if (sex == 1 && preg == 1) {
                bootbox.alert("အသက် ၁၀ နှစ်နှင့် ၆၀ အတွင်းသာ \"ကိုယ်ဝန်ဆောင်\" ရွေးခွင့်ရှိသည်။", function(e) {}).on('hidden.bs.modal', function() {
                    $(age).focus();
                });
...
// function getAssumResult(rtd, micro) {
//     var rdt = td.find('td:eq(10) select').val();
//     var micro = td.find('td:eq(9) select').val();

//     if (rtd == 1) {
//         if (rtd == 1 && micro == 0) {
//             result = 1;
//         } else if (rtd == 1 && micro == 1) {
//             result = 1;
//         } else if (rtd == 1 && micro == 2) {
//             result = 3;
//         } else if (rtd == 1 && micro == 3) {
//             result = 3;
//         } else if (rtd == 1 && micro == 4) {
//             result = 1;
//         } else if (rtd == 1 && micro == 5) {
//             result = 1;
//         }
//     } else if (rtd == 2) {
//         if (rtd == 2 && micro == 0) {
//             result = 2;
//         } else if (rtd == 2 && micro == 1) {
//             result = 3;
//         } else if (rtd == 2 && micro == 2) {
//             result = 2;
//         } else if (rtd == 2 && micro == 3) {
//             result = 3;
//         } else if (rtd == 2 && micro == 4) {
//             result = 2;
//         } else if (rtd == 2 && micro == 5) {
//             result = 2;
//         }
//     } else if (rtd == 3) {
//         if (rtd == 3 && micro == 0) {
//             result = 3;
//         } else if (rtd == 3 && micro == 1) {
//             result = 3;
//         } else if (rtd == 3 && micro == 2) {
//             result = 3;
//         } else if (rtd == 3 && micro == 3) {
//             result = 3;
//         } else if (rtd == 3 && micro == 4) {
//             result = 3;
//         } else if (rtd == 3 && micro == 5) {
//             result = 3;
//         }
//     }
// }
...
function getAssumResult(rtd, micro) {
    ...
    if (rtd == 1) {
        if (micro == 0 || micro == 1 || micro == 4 || micro == 5) {
            result = 1;
        } else if (micro == 2 || micro == 3) {
            result = 3;
        }
    } else if (rtd == 2) {
        if (micro == 0 || micro == 2 || micro == 4 || micro == 5) {
            result = 2;
        } else if (micro == 1 || micro == 3) {
            result = 3;
        }
    } else if (rtd == 3) {
        result = 3; // rtd is 3, so result is always 3 regardless of micro
    }
...
function checkRDT(rdt) {
    ...
    if (rdt.value == '0' || rdt.value == '7' || rdt.value == '9') {
    ...
    } else if (getAssumResult(rdt, micro) == 1) {
        if (age < 1) {
            tr.find('td:eq(12) select').removeProp('selectedIndex', 8).prop('disable', true);
            tr.find('td:eq(13) select').val(N / A).prop('disabled', true);
            tr.find('td:eq(14) select').val(N / A).prop('disable', true);
        } else if (age >= 1 && age <= 4) {
            tr.find('td:eq(12) select').removeProp('selectedIndex', 1).prop('disable', true);
            tr.find('td:eq(13) select').val(N / A).prop('disabled', true);
            tr.find('td:eq(14) select').val(1).prop('disable', true);
        } else if (age >= 5 && age <= 9) {
            tr.find('td:eq(12) select').removeProp('selectedIndex', 2).prop('disable', true);
            tr.find('td:eq(13) select').val(N / A).prop('disabled', true);
            tr.find('td:eq(14) select').val(2).prop('disable', true);
        } else if (age >= 10 && age <= 14 && preg == 1 || preg == 2) {
            tr.find('td:eq(12) select').removeProp('selectedIndex', 3).prop('disable', true);
            tr.find('td:eq(13) select').val(N / A).prop('disabled', true);
            tr.find('td:eq(14) select').val(4).prop('disable', true);

        } else if (age >= 15 && preg == 1 || preg == 2) {
            tr.find('td:eq(12) select').removeProp('selectedIndex', 4).prop('disable', true);
            tr.find('td:eq(13) select').val(N / A).prop('disabled', true);
            tr.find('td:eq(14) select').val(6).prop('disable', true);
        }
        // } else if (getAssumResult(rdt, micro) == 2) {
        //     if (age < 1) {
        //         tr.find('td:eq(12) select').removeProp('selectedIndex', 0).prop('disable', true);
        //         tr.find('td:eq(13) select').val(1).prop('disabled', true);
        //         tr.find('td:eq(14) select').val(N / A).prop('disable', true);
        //     } else if (age >= 1 && age <= 4) {
        //         tr.find('td:eq(12) select').removeProp('selectedIndex', 0).prop('disable', true);
        //         tr.find('td:eq(13) select').val(4).prop('disabled', true);
        //         tr.find('td:eq(14) select').val(7).prop('disable', true);
        //     } else if (age >= 5 && age <= 9) {
        //         tr.find('td:eq(12) select').removeProp('selectedIndex', 0).prop('disable', true);
        //         tr.find('td:eq(13) select').val(5).prop('disabled', true);
        //         tr.find('td:eq(14) select').val(14).prop('disable', true);
        //     } else if (age >= 10 && age <= 14 && preg == 1 || preg == 2) {
        //         tr.find('td:eq(12) select').removeProp('selectedIndex', 0).prop('disable', true);
        //         tr.find('td:eq(13) select').val(7.5).prop('disabled', true);
        //         tr.find('td:eq(14) select').val(21).prop('disable', true);

        //     } else if (age >= 15 && preg == 1 || preg == 2) {
        //         tr.find('td:eq(12) select').removeProp('selectedIndex', 0).prop('disable', true);
        //         tr.find('td:eq(13) select').val(10).prop('disabled', true);
        //         tr.find('td:eq(14) select').val(28).prop('disable', true);
        //     }
        // } else if (getAssumResult(rdt, micro) == 3) {
        //     if (age < 1) {
        //         tr.find('td:eq(12) select').removeProp('selectedIndex', 8).prop('disable', true);
        //         tr.find('td:eq(13) select').val(N / A).prop('disabled', true);
        //         tr.find('td:eq(14) select').val(N / A).prop('disable', true);
        ...
        tr.find('td:eq(11) input').attr('type', 'text').attr('placeholder', 'ဆေးလုံးရေ');
        tr.find('td:eq(12) input').val('');
        tr.find('td:eq(12) input').attr('type', 'text').attr('placeholder', 'ဆေးလုံးရေ');
...
// const microtest = "pf";
// const rtdtest = "pf";
// const result = calculateResult(microtest, rtdtest);
// console.log(result); // Output: "pf"

// End Case result
//Start Add byme

function checkCQ(row) {
    ...
    if (rdt == 2) {
        if (age < 1) {
            if (row.value > 1) {
                bootbox.alert("ဆေးလုံးရေပိုပေးထားသည်။");
            }
        } else if (age >= 1 && age <= 4) {
            if (row.value > 4) {
                bootbox.alert("ဆေးလုံးရေပိုပေးထားသည်။");
        ...
        if (row.value == 77 || row.value == 99) {
            ...
            bootbox.alert("ဖယ်လ်ဆီပရမ်(pf)လူနာတွင် 'CQ' မပေးပါ။");
        }
    }
}

function checkPQ(row) {
    var td = $(row).closest('tr');
    var age = td.find('td:eq(3) input').val();
    var preg = td.find('td:eq(7) select').val();
    var rdt = td.find('td:eq(9) select').val();
    ...
    if (rdt == 1) {
        if (age < 1 || preg == 1) {
            if (row.value == 77 || row.value == 99) {
                ...
                bootbox.alert("အသက်(၁)နှစ်အောက်နှင့် ကိုယ်ဝန်ဆောင်လူနားများကို 'PQ' မပေးပါ။");
            }
        } else if (age >= 1 && age <= 4) {
            if (row.value > 1 && row.value != 77 && row.value != 99) {
                bootbox.alert("ဆေးလုံးရေပိုပေးထားသည်။");
            }
        } else if (age >= 5 && age <= 9) {
            if (row.value > 2 && row.value != 77 && row.value != 99) {
                bootbox.alert("ဆေးလုံးရေပိုပေးထားသည်။");
            }
        } else if (age >= 10 && age <= 14) {
            if (row.value > 4 && row.value != 77 && row.value != 99) {
                bootbox.alert("ဆေးလုံးရေပိုပေးထားသည်။");
            }
        } else if (age >= 15) {
            if (row.value > 6 && row.value != 77 && row.value != 99) {
                bootbox.alert("ဆေးလုံးရေပိုပေးထားသည်။");
            }
        } else {
...
function checkACT(row) {
    var td = $(row).closest('tr');
    var rdt = td.find('td:eq(9) select').val();
    if (rdt == 2) {
        if (row.value > 0) {
            bootbox.alert("No ACT at Pv/Non PF Patient");
        }
    }
}
...
function checkPQvhv(row) {
    ...
    var preg = td.find('td:eq(7) select').val();
    if (age < 5 || preg == '1') {
        bootbox.alert("အသက်(၁)နှစ်အောက်နှင့် ကိုယ်ဝန်ဆောင်လူနာများကို PQ မပေးပါ။");
    }
...
function clickOnRow() {
        ...
        if (cqpq.className === 'cq only-integer') {
            if (parseInt(cq) > 50) {
                if (parseInt(cq) != 77 && parseInt(cq) != 99) {
                    // alert('show me');
                    bootbox.alert('ဆေးလုံးရေ ၅၀ ထပ်ပိုမပေးသင့်ပါ။(N/A for 77 or Missing for 99)')
                        .on('hidden.bs.modal', function() {
                            $(cqpq).focus();
                        });
                ...
                if (parseInt(rcs_value) == 1 || parseInt(rdt_value) == 1 || parseInt(rcs_value) == 3 || parseInt(rdt_value) == 3) {
                    bootbox.alert('Pf/Mixed ပိုးတွင် CQ မပေးပါ။(N/A for 77 or Missing for 99)').on('hidden.bs.modal', function() {
                        $(cqpq).focus();
                    });
                }
            }
        ...
        if (this.className === 'pq only-integer') {
            ...
            if (parseInt(pq) > 50) {
                ...
                if (parseInt(age) < 1 || parseInt(preg) == 1) {
                    bootbox.alert('အသက်(၁)နှစ်အောက်နှင့်ကိုယ်ဝန်ဆောင်များကို PQ မပေးပါ။(N/A for 77 or Missing for 99)').on('hidden.bs.modal', function() {
                        $(cqpq).focus();
                    });
                }
                if ((positive_value.indexOf(parseInt(rcs_value)) != -1 || positive_value.indexOf(parseInt(rdt_value)) != -1) &&
        ...
        switch (this.value) {
            ...
            case '1':
                if (!(positive_value.indexOf(parseInt(rdt_value)) !== -1)) {
                    ...
                    bootbox.alert("အသက်တစ်နှစ်အောက်တွင်သုံးလုံးသာပေးသည်။").on('hidden.bs.modal', function() {
                        $(actvhv).focus(); //"အသက်(၁)နှစ်မှ(၄)နှစ်တွင်သာ Coartem - 6 ပေးသည်။"
                    });
                }
                break;
            case '2':
    ...
    $('.cqvhv, .pqvhv').on('change', function(e) {
        ...
        if (this.className === 'pqvhv only-integer') {
            ...
            if (parseInt(pq) > 50) {
                if (parseInt(pq) != 77 && parseInt(pq) != 99) {
                    bootbox.alert('ဆေးလုံးရေ ၅၀ ထပ်ပိုမပေးသင့်ပါ။(N/A for 77 or Missing for 99)').on('hidden.bs.modal', function() {
                        $(cqvhv).focus();
                    });
                } else if ((positive_value.indexOf(parseInt(rcs_value)) != -1 || positive_value.indexOf(parseInt(rdt_value)) != -1) &&
                    (parseInt(pq) == 0 || parseInt(pq) == 77 || parseInt(pq) == 99)) {
