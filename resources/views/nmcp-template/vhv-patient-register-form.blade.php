            ...
            <div class="sec-row text-center">
                ...
                <div class="vhv-block">
                    <label class="sec-label mmtext-12">စေတနာ့ဝန်ထမ်းအမည် 
                        <input id="vhv_name" class="sec-row-label" value="{{ $vhv->VHV_Name }}" org_vhvid='{{ $vhv->OrgVHV_ID }}'>
                    </label>
                </div>
                ...
                <table class="table table-bordered dataTable" id="register-table">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><input type="text" placeholder="ရက်စွဲ" class="dentry_date" value="<?= $day .'-'. $month .'-'. $year ?>"></td>
                            <td><input type="text" placeholder="အမည်" value="<?=$patient->Pt_Name;?>"></td>
                            <td><input type="text" placeholder="အသက်" value="<?=$patient->Age_Year;?>" class="agevhv dentry_age" onchange="checkAge(this)"></td>
                            <td>
                                <select name="address" id="" value="<?=$patient->Pt_Location;?>" onblur="location_changed(this)">
                                    ...
                                    @elseif($patient->Pt_Location == 20)
                                        <option value="{{ $patient->Pt_Location}}" selected >Other Within Township</option>
                                        @foreach($tbl_village as $v)
                                        <option value="{{ $v->village_pcode }}">
                                            {{ $v->village}} &nbsp;&nbsp;&nbsp;&nbsp;| {{ $v->village_tract }}
                                        </option>    
                                    ...
                                    @elseif($patient->Pt_Location == 30)
                                        <option value="{{ $patient->Pt_Location}}" selected>Other Outside Township</option>
                                        @foreach($tbl_village as $v)
                                        <option value="{{ $v->village_pcode }}">
                                            {{ $v->village}} &nbsp;&nbsp;&nbsp;&nbsp;| {{ $v->village_tract }}
                                        </option>    
                            ...
                            <td>
                                <input type="text" placeholder="မှတ်ချက်(Optional)" value="<?=$patient->Remark;?>">
                            </td>
                            <td>
                                <a href="javascript:void(0)" class="delete_icon" onClick="delete_existing_row(<?=$patient->P_Number;?>,<?=$patient->sync;?>);" rowNo="">
