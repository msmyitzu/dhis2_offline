    ...
    <div class="row">
        <div class="col-md-7">
                <div class="text-center" style="border: 1px solid #E3E3E3; background-color:#FBFBFB">
                    <h5>ပုံစံအချက်အလက်များကိုသေချာရွှေးချယ်ပါ။</h5>
                    <form class="form-horizontal" id="frm-patient-register-form" method="post" 
                    action="patient-register-form">
                        {{ csrf_field() }}
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control num-only" placeholder="0000" style="text-align:center;"
                                    min="1000" max="9999" maxlength="4" id="form_number" name="form_number" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    id="select_lp_state_region"  required
                                ...
                                ?>
                                    ...
                                    class="form-control select2 select_lp_township_de" style="width: 100%;">
                                        ...
                                        @foreach($lp_township as $ts)
                                            <option value="{{ $ts->ts_code }}" {{ session('role_id') == '3' ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                <label for="" id="rhc_label" class="col-md-4 control-label"></label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label for="" id="sc_label" class="col-md-4 control-label"></label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 date" style="padding-right: 15px; padding-left: 15px">
                                    <input type="text" class="form-control text-center" id="form-date" name="form-date" autocomplete=off  placeholder="လ / ခုနှစ်" readonly>
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            <div class="col-md-6">
                                ...
                                id="btn_submit_data_entry_form" onclick = "submit_data_entry_form('<?= session('role_id') ?>');">
                                    Goto Form<br>
                                    ပုံစံသို့သွားရန်
                                </button>
                            </div>
                            <div class="col-md-6">
                                <button type="button" class="btn btn-block btn-default" style="padding: 25px;" onclick="clear_data_entry();">
            ...
            <div class="col-md-12" style="text-align: center; margin-top: 10px;">
                <p style="font-size: 12px">
                    ဤနေရာတွင် အချက်အလက်များထည့်သွင်းရန် ပုံစံတစ်ခုချင်းစီကို စစ်ဆေးပါ။ ပြီးလျှင် ညွှန်ကြားထားသည့်အတိုင်း ပုံစံအမှတ်တပ်ပေးပါ။ အပေါ်တွင် ရွှေးချယ်ရမည့်နေရာများတွင် ပုံစံနှင့်သေချာတိုက်ဆိုင်စစ်ဆေးပြီး ရွှေးချယ်ထည့်သွင်းပါ။ အကယ်၍ တစ်ခုခုမှားယွင်းရွှေးချယ်ခဲ့လျှင်
                    ပုံစံတစ်ခုလုံးပြန်ဖျက်ရမည်ဖြစ်ပြီး အစမှပြန်သွင်းရမည်ဖြစ်ပါသည်။ အထူးသဖြင့် - ပုံစံအမျိုးအစား၊ ပုံစံအမှတ်၊ ကျန်းမာရေးဌာနခွဲ/စေတနာ့ဝန်ထမ်းကျေးရွာ၊ ပုံစံရှိလနှင့် ခုနှစ်တို့ကိုသေချာရွှေးချယ်ပါ။ ရွှေးချယ်ထားသည့်အချက်အလက်များကို
                    ပြန်ရှင်းချင်လျှင် “Refresh/ပြန်ရှင်းရန်” ကိုနှိပ်လိုက်ပါ။ အကွက်ထဲတွင် ရွှေးချယ်ထားသောအချက်အလက်များရှင်းသွားပါမည်။ မှားထည့်မိသည့်ပုံစံကိုဖျက်လျှင်လည်း အချက်အလက်များကို သေချာရွှေးချယ်ပါ။
                </p>
            </div>
