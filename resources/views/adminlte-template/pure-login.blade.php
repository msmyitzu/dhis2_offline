...
<body class="hold-transition login-page">
    <div style="padding-top: 20px; margin-bottom: 0px; box-sizing: border-box;">
        ...
        <table style="margin:auto; width: 800px; color:white; font-size:small;">
                <tr>
                    <td colspan="3" align="center"><h3 style="font-size: 18px;">Ministry of Health and Sports, Myanmar</h3></td>
                </tr>
                <tr>
                    ...
                    <td width="100px" style="padding: 10px;"><img src="/img/logo.png" width="100px" /></td>
                    <td width="350px">
    ...
    <div class="alert alert-danger alert-block text-center ct-margin">
        <button type="button" class="close" data-dismiss="alert">×</button>
        <strong>{{ $message }}</strong>
    </div>
    @endif
    ...
    <div class="login-box">
        <div class="login-box-body">
            <p class="text-center" id="login_message">Re-Enter Username and Password</p>
