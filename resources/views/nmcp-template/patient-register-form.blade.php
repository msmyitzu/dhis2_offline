...
<head>
        ...
        <![endif]-->
        <script>//bootbox.alert("အချက်အလက်များ မှားယွင်းခြင်းမဖြစ်စေရန် ဤစာမျက်နှာပေါ်တွင် browser refresh (⭮) လုပ်ခြင်း (သို့) back button (⭠) နှိပ်ခြင်း (လုံးဝ) မပြုလုပ်ရန် ကြိုတင်သတိပေးအပ်ပါသည်။");</script>
    ...
    <div class="wrap">
        <div class="row">
            ...
            <div class="first-row" style="text-align: center;">
                <label class="control-label top-label">တိုင်းဒေသကြီး/ပြည်နယ်  <span class="top-label-value">{{ $lp_state_region_name }}</span></label>
                <label class="control-label top-label">မြို့နယ်  <span class="top-label-value">{{ $lp_township_name }}</span></label>
                <label class="control-label top-label">မြို့နယ်ဆေးရုံ/တိုက်နယ်ဆေးရုံ/ ကျေးလက်ကျန်းမာရေးဌာန  <span class="top-label-value">{{ $tbl_hfm_sc_name }}</span></label>
                <label class="control-label top-label">ကျေးလက်ကျန်းမာရေးဌာနခွဲ/နယ်စပ်ဆေးပေးခန်း  <span class="top-label-value">{{ $hfm_name }}</span></label>
            </div>
            ...
            <tbody id='tbody_iop'>
                <tr>
                    ...
                    <td><input class="" type="number" id='txt_Total_Outpatient' value={{ $tp->Total_Outpatient }}></td>
                    <td>ငါးနှစ်အောက်အထွေထွေဆေးခန်းလာ(ပြင်ပ)</td>
                    <td><input class="" type="number" id='txt_U5_Outpatient' value="{{ $tp->U5_Outpatient }}"></td>
                    <td>ကိုယ်ဝန်ဆောင်အထွေထွေဆေးခန်းလာ(ပြင်ပ)</td>
                    <td><input class="" type="number" id='txt_Preg_Outpatient' value="{{ $tp->Preg_Outpatient }}" onblur="chNumOut()"></td>
                    <td></td>
                    <td></td>
                    <td>လ</td>
                ...
                <tr>
                    ...
                    <td><input type="number" class=""  id='txt_Total_Inpatient' value="{{ $tp->Total_Inpatient }}"></td>
                    <td>ငါးနှစ်အောက်အထွေထွေဆေးခန်းလာ(အတွင်း)</td>
                    <td><input type="number" class=""  id='txt_U5_Inpatient' value="{{ $tp->U5_Inpatient }}"></td>
                    <td>ကိုယ်ဝန်ဆောင်အထွေထွေဆေးခန်းလာ(အတွင်း)</td>
                    <td><input type="number" class=""  id='txt_Preg_Inpatient' value="{{ $tp->Preg_Inpatient }}" onblur="chNumIn()"></td>
                    <td>ဆေးရုံတွင်သေဆုံးသူစုစုပေါင်း</td>
                    <td><input type="number" class=""  id='txt_Death_Facility' tp_code="{{ $tp->TP_Code }}" value="{{ $tp->Death_Facility }}"></td>
                    <td>ခုနှစ်</td>
            ...
            <tbody id='tbody_iop'>
                <tr>
                    ...
                    <td>ကိုယ်ဝန်ဆောင်အထွေထွေဆေးခန်းလာ(ပြင်ပ)</td>
                    <td><input type="number" class=""  id='txt_Preg_Outpatient' value="0" onblur="chNumOut()"></td>
                    <td></td>
                    <td></td>
                    <td>လ</td>
                    <td><input type="text" id='frm_month'value='{{ $form_month }}' disabled></td>
                ...
                <tr>
                    ...
                    <td>ကိုယ်ဝန်ဆောင်အထွေထွေဆေးခန်းလာ(အတွင်း)</td>
                    <td><input type="number" class=""  id='txt_Preg_Inpatient' value="0" onblur="chNumIn()"></td>
                    <td>ဆေးရုံတွင်သေဆုံးသူစုစုပေါင်း</td>
                    <td><input type="number" class=""  tp_code="" id='txt_Death_Facility' value="0"></td>
                    <td>ခုနှစ်</td>
                    <td><input type="text" id='frm_year' value='{{ $form_year }}' disabled></td>
                </tr>
                </tbody>
            ...
            <div class="col-md-12" style="padding: 0px;">
                ...
                style="margin-top: 10px; margin-bottom: 10px;" onClick="add_row(this)" id="add_row">
                ...
                <table class="table table-bordered dataTable" id="register-table">
                    ...
                    ?>
                        <tr>
                            <td style="font-size:10px; font-weight: bold;" P_Number="<?=$patient->P_Number;?>">1</td>
                            <td>
                                <input type="text" placeholder="ရက်စွဲ" class='dentry_date'
                                value = "<?= $day.'-'.$month.'-'.$year ?>">
                            </td>
                            <td><input type="text" placeholder="အမည်" value="<?=$patient->Pt_Name;?>"></td>
                            <td><input type="text" placeholder="အသက်" value="<?=$patient->Age_Year;?>" class="age dentry_age" onchange="checkAge(this)"></td>
                            <td>
                            ...
                            <td><input type="text" placeholder="ရွာ-မြို့-ပြည်-နယ်-တိုင်း" value="<?=$patient->Pt_Address;?>"></td>
                            <td>
                            ...
                            <td>
                                <input type="number" value="{{ $patient->CQ_Code }}" class="cq only-integer">
                            </td>
                            <td>
                                <input type="number" value="{{ $patient->PQ_Code }}" class="pq only-integer">
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="delete_icon" onClick="delete_existing_row(<?=$patient->P_Number;?>,<?=$patient->sync;?>, this);" rowNo="">
        ...
        <script>
            ...
            function save_data_entry(button) {
                ...
                if (save_update_check == "1" || save_update_check == "2") {
                    ...
                    for (var i = 0, row; row = table.rows[i]; i++) {
                        ...
                        //Added on 2019-07-17
                        var dedt = row.cells[1].children[0].value ;
                        if(dedt == ""){
            ...
            function add_row(btn){
                ...
                if(row_count >= 17){
					...
					$.ajax({
						type: "GET",
						url: "http://" + window.location.host +"/get_patient_dataentry_row/{{ $lp_township_de }}",
						data: "",
            ...
            function delete_existing_row(p_number, sync, btn){
                if(sync == "1"){
                    bootbox.alert("ဤအချက်အလက်သည် server ပေါ်သို့ပို့ဆောင်ပြီးဖြစ်ပါသဖြင့် ပြုပြင်ခြင်း၊ဖျက်ခြင်းများ ခွင့်မပြုပါ");
                    return false;
                }else{
                    $.ajax({
