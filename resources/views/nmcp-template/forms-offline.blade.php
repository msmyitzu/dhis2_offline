                                    ...
                                    <tbody id="grab_all_corefacility_container">
                                        ...
                                        @foreach ($grab_all_corefacility_temp as $cf)
                                            <tr title="လူနာအချက်အလက်များကြည့်ရန် နှိပ်ပါ"
                                                ...
                                                <td align="right" cf_code="{{ $cf->CF_Code }}">{{ $core_count-- }}
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    switch ($cf->sync) {
                                                        case '0':
                                                            echo "<span class='sync_offline'>offline</span>";
                                                            break;
                                                        case '1':
                                                            echo "<span class='sync_online'>online</span>";
                                                            break;
                                                    }
                                                    ?>
                                                </td>
                                                <td>
                                                    <div class="btn-group" style="width:max-content">
                                                        <button title="ဖောင်သို့သွားရန်" type="buttom"
                                                            class="btn btn-info btn-xs"
                                                            onClick="goto_form('{{ $cf->cf_link_code }}')">
                                                            <i class="fa fa-edit"></i>
                                                        </button>
                                                        <button title="ဖောင်ဖျက်ရန်" type="button"
                                                            class="btn btn-danger btn-xs"
                                                            cf_link_code="{{ $cf->cf_link_code }}"
